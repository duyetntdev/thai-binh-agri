            ...
            <div class="flex items-center gap-2">
                <div class="flex items-center border border-gray-200 rounded-lg overflow-hidden text-sm">
                    <button type="button" wire:click="decrementQuantity"
                            class="px-2 py-1 text-gray-500 hover:bg-gray-100 transition">−</button>
                ...
                <button type="button" wire:click="add"
                        ...
                        class="inline-flex items-center justify-center h-9 w-9 rounded-lg bg-green-600 text-white shadow-sm">
                    ...
                    <span wire:loading wire:target="add" class="text-xs">...</span>
                </button>
            </div>
